...
int main(int args, char* argc[]) {
    ...
    pico_set_view(0, &dim, NULL, NULL, NULL, NULL, NULL, NULL);
    ...
    Pico_Rel_Rect quadro = { '%', {0.75, 0.45, 0.5, 0}, PICO_ANCHOR_C, NULL };
    Pico_Rel_Rect escolha = {'%', {0.75, 0.20, 0.40, 0.1}, PICO_ANCHOR_C, NULL};
    ...
    for (int i = 0; i < CORES; i++) {
        ...
        pico_output_draw_image(path,
                            &(Pico_Rel_Rect){'%', {0.6 +0.08*(i%5) , 0.35 + 0.1*(i/5) ,0.05,0}, PICO_ANCHOR_C, NULL});
    }
    pico_output_present();
